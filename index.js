...
export function restStore (mappings, storeAdapter, ajaxAdapter = axiosAdapter()) {
  ...
  return {
    ...
    find (path, clientQuery, httpOptions) {
      ...
      const {url, params, headers, force, query, identifier, transformResponse} = options
    ...
    findAll (path, clientQuery, httpOptions) {
      ...
      const {url, params, headers, force, query, transformResponse} = options
    ...
    create (path, attributes, options = {}) {
      ...
      const {url, params, headers, transformResponse} = opts
    ...
    update (path, clientQuery, attributes, options = {}) {
      ...
      const {url, params, headers, identifier, transformResponse} = opts
